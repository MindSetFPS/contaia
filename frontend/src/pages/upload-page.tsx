...
export default function UploadPage() {
  ...
  return (
    <div className="flex flex-1 flex-col min-h-0 overflow-y-auto">
      <div className="flex flex-col items-center gap-4 sm:gap-6 p-4 sm:p-6 w-lg mx-auto">
        <div>
          <h1 className="text-lg font-bold">Subir datos</h1>
          <h2>Carga un archivo Excel con datos financieros de tu cliente.</h2>
        </div>
        {selectedClient ? (
        ...
        {status === "success" && result && (
          <div className="rounded-lg border border-green-200 bg-green-50 p-4 text-sm text-green-800 space-y-1 dark:border-green-800 dark:bg-green-950 dark:text-green-200">
            ...
            {result.unused_columns.length > 0 && (
              <p>Columnas no utilizadas: {result.unused_columns.join(", ")}</p>
            )}
          </div>
        )}
